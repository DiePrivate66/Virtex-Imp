...
REPLAY_GATEWAY_IDLE_TIMEOUT_SECONDS = float(os.environ.get('REPLAY_GATEWAY_IDLE_TIMEOUT_SECONDS', '5'))
REPLAY_GATEWAY_UPSTREAM_TIMEOUT_SECONDS = float(os.environ.get('REPLAY_GATEWAY_UPSTREAM_TIMEOUT_SECONDS', '120'))
REPLAY_GATEWAY_COLD_LANE_HOURS = int(
    os.environ.get('REPLAY_GATEWAY_COLD_LANE_HOURS', str(POS_REPLAY_COLD_LANE_HOURS))
)
REPLAY_GATEWAY_COLD_LANE_SLOTS = int(
    os.environ.get('REPLAY_GATEWAY_COLD_LANE_SLOTS', str(POS_REPLAY_COLD_LANE_SLOTS))
)
REPLAY_GATEWAY_COLD_SLICE_SECONDS = float(os.environ.get('REPLAY_GATEWAY_COLD_SLICE_SECONDS', '120'))
REPLAY_GATEWAY_WAITER_TTL_SECONDS = float(
    os.environ.get(
        'REPLAY_GATEWAY_WAITER_TTL_SECONDS',
        str(max(POS_REPLAY_RETRY_AFTER_SECONDS * 3, 30)),
    )
)
REPLAY_GATEWAY_BUCKET_COUNT = int(os.environ.get('REPLAY_GATEWAY_BUCKET_COUNT', '8'))

# --- REPLAY COORDINATOR (distribuido) ---
REPLAY_COORDINATOR_BACKEND = os.environ.get(
    'REPLAY_COORDINATOR_BACKEND',
    'memory_dev' if DEBUG else 'redis',
)
REPLAY_COORDINATOR_REDIS_URL = os.environ.get(
    'REPLAY_COORDINATOR_REDIS_URL',
    REDIS_URL if REDIS_URL else '',
)
REPLAY_TICKET_TTL_SECONDS = int(os.environ.get('REPLAY_TICKET_TTL_SECONDS', '30'))
...
OFFLINE_JOURNAL_LIMBO_RECENT_LIMIT = int(os.environ.get('OFFLINE_JOURNAL_LIMBO_RECENT_LIMIT', '50'))
OFFLINE_JOURNAL_HISTORY_LIMIT = int(os.environ.get('OFFLINE_JOURNAL_HISTORY_LIMIT', '5'))
