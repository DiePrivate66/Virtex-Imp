...
from pos.application.notifications import notify_delivery_group
from pos.models import DeliveryQuote, Venta, WhatsAppConversation
...
@shared_task(
    name='pos.infrastructure.tasks.send_delivery_quote_requests',
    bind=True,
...
@shared_task(
    name='pos.infrastructure.tasks.process_delivery_quote_timeout',
    bind=True,
    autoretry_for=(Exception,),
    retry_backoff=True,
    retry_kwargs={'max_retries': 3},
...
@shared_task(
    name='pos.infrastructure.tasks.notify_customer_quote_total',
    bind=True,
    autoretry_for=(Exception,),
    retry_backoff=True,
    retry_kwargs={'max_retries': 3},
...
@shared_task(name='pos.infrastructure.tasks.set_quote_and_notify', bind=True)
...
@shared_task(name='pos.infrastructure.tasks.sweep_delivery_quote_timeouts', bind=True)
