...
- esa tabla ahora soporta filtros operativos por tipo de accion, organizacion, sucursal y actor, preservando el periodo activo del dashboard para que la revision siga siendo contextual
